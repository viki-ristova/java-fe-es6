// we'll be importing stuff from './helpers/module-a', first export stuff from there in order to import them here
...
// 5. how could we avoid the default alias when
// importing `add` and `theQuestion`?

// 6. how could we import everything onto a single
